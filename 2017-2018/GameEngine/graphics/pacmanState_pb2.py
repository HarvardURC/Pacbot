...
_PACMANSTATE_POSITION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='dir', full_name='gameEngine.PacmanState.Position.dir', index=2,
...
_PACMANSTATE_POSITION.fields_by_name['dir'].enum_type = _PACMANSTATE_DIRECTION
